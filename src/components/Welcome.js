    ...
    >
      ...
      <div className="field">
        ...
        <div className="control">
          <input className="input is-large" type="text" placeholder="Enter your name" name="player" required onChange={handleNameInput} />
        </div>
      </div>
      <button type="button" className="button p-6 is-size-2 is-large play-button" onClick={() => handlePlay()} disabled={!player}>
        Play!
      </button>
    </form>
  ) : (
